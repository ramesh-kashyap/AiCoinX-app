    ...
    <div>
      ...
      >
        ...
        <div class="px-6 py-8 relative z-20 w-full" >
          ...
          <div
            class="flex justify-between items-center gap-4 bg-white3 bg-opacity-5 rounded-lg py-3 px-4" style={{ backgroundColor: '#fff', border: '1px solid #e9e2e2' }}
          >
            <input
              type="text"
              value={search}
          ...
          <div class="flex flex-col gap-2 pt-5">
            {users.length > 0 ? (
              users.map((user, index) => (
                <>
                  <div
                    class="flex justify-between items-center  bg-opacity-5 p-4 rounded-xl" style={{ boxShadow: "rgba(68, 110, 253, 0.2) 9px 6px 12px", borderRadius: '10px' }}
                    key={index}>
